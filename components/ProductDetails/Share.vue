<template>
  ...
  >
    <button
      ...
      class="flex flex-row px-4 py-2 rounded-full me-3 focus:outline-none hover:shadow-lg hover:bg-gray-300"
    >
      <svg
    ...
    <div v-if="open && data" class="">
      <div
        class="absolute z-50 items-center w-4/5 mt-2 overflow-y-auto bg-white border rounded-sm shadow-2xl right-8 sm:right-0 sm:overflow-hidden sm:p-3 sm:w-2/5 sm:h-32"
      >
        <div
          class="flex flex-col h-full sm:justify-around sm:my-auto sm:flex-wrap sm:flex-row"
        >
          ...
          <div class="flex flex-col w-full sm:flex-row">
            ...
            <ShareNetwork
              ...
              style="color: #3b5998"
              @click="close(null)"
              class="flex flex-row items-center w-full mx-auto border-b sm:flex-col focus:outline-none sm:border-b-0 sm:ps-0 ps-4"
            >
              <svg
                class="my-2 rounded-full cursor-pointer sm:my-auto hover:shadow-lg"
                width="50"
                height="50"
                viewBox="0 0 50 50"
                xmlns="http://www.w3.org/2000/svg"
            ...
            <ShareNetwork
              ...
              style="color: #54cc61"
              @click="close(null)"
              class="flex flex-row items-center w-full mx-auto border-b sm:hidden sm:flex-col focus:outline-none sm:border-b-0 sm:ps-0 ps-4"
            >
              <svg
                version="1.1"
