<template>
  <div v-if="productReviews" class="px-2">
    <div
      class="flex justify-start h-12 p-3 my-auto font-normal text-center capitalize bg-gray-300"
    >
      Rarting and reviews
    </div>
    <div v-for="r in productReviews.data" :key="r.id" class="py-5 border-b">
      <div class="flex flex-row justify-between mb-3">
        <div class="flex flex-row">
          <div
            class="flex flex-row items-center justify-center w-20 h-8 my-auto text-base font-normal tracking-wider text-gray-600 bg-gray-300 rounded me-4"
          >
    ...
    <div class="flex flex-col justify-between my-4 sm:flex-row">
      ...
      <button
        class="px-4 py-2 mt-4 text-base font-light text-gray-600 bg-gray-300 border-none rounded sm:mt-0 ring-1 ring-gray-300 focus:ring-1 focus:ring-gray-400 focus:ring-offset-2 focus:outline-none hover:bg-gray-200"
      >
        Post Your Question
      </button>
    </div>
