  ...
  <div v-if="product && product.id" class="xl:me-3 sm:px-8 md:px-0">
    <button
      ...
      @click="
        ...
        go('/cart')
      "
      class="flex items-center justify-center w-full p-2 text-center ease-in-out bg-white border-2 shadow sm:rounded button text-primary-500 me-3 border-primary-500 focus:ring-opacity-50 hover:opacity-80 focus:ring focus:ring-offset-2 focus:ring-yellow-600 focus:outline-none d:px-6 md:p-3"
    >
      <!-- loading icon -->
