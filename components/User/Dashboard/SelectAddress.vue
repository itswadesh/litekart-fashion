      ...
      >
        ...
        >
          <label class="flex flex-row w-full p-2 px-3 sm:p-4 sm:px-6">
            ...
            />
            <div
              class="w-full text-base font-light leading-7 text-gray-500 cursor-pointer ms-2"
            >
          ...
          <div
            class="flex flex-row w-full px-3 my-auto mt-5 sm:mt-0 sm:justify-between sm:px-7"
          >
            ...
            <div class="flex flex-row">
              ...
              <button
                @click="edit(a.id)"
                type="button"
                class="w-full px-5 text-sm tracking-widest uppercase bg-white border rounded sm:p-1 sm:px-3 text-primary-500 border-primary-500 focus:outline-none focus:ring-opacity-50 hover:opacity-80 focus:ring focus:ring-offset-2 focus:ring-primary-200 lg:rounded"
              >
                Edit
              </button>
              <!-- </nuxt-link> -->
              <button
                @click="del(a.id)"
                type="button"
                class="w-full p-2 px-3 text-sm tracking-widest text-gray-400 uppercase rounded ms-3 focus:outline-none focus:ring-opacity-50 hover:opacity-80 focus:ring focus:ring-offset-2 lg:rounded"
              >
