<template>
  <div class="h-auto mx-auto bg-black conatiner lg:px-10" v-if="deals">
    <div class="h-auto focus:outline-none">
      ...
      >
        ...
        <div class="items-center p-2 mx-auto my-auto text-white">
          ...
          <div class="flex flex-row lg:flex-col" v-if="!isexpired">
            <div
              class="flex flex-col my-auto text-xs ms-4 me-2 lg:ms-0 lg:me-0 lg:mx-0 lg:flex-row"
              v-if="isStarted"
            >
