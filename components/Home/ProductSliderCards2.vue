<template>
  <div class="focus:outline-none">
    <div class="flex flex-row w-full focus:outline-none">
      <div
        class="items-center w-full mx-auto mt-8 border shadow rounded-tr-2xl h-68 focus:outline-none"
      >
        <nuxt-link
        ...
        >
          <div
            class="flex flex-row w-full mx-auto overflow-hidden bg-white rounded-tr-2xl focus:outline-none"
          >
            <img
              v-lazy="product.img"
              alt=""
          ...
          <!-- style="height:86px;" -->
          <div class="p-3 border-t bg-accent-100">
