<template>
  <div class="container mx-auto">
    <div v-if="!signin">
      ...
      >
        <span
          class="flex justify-center px-12 text-base font-thin text-center text-gray-400"
      ...
      <div class="flex justify-center">
        <button @click="signin = !signin" class="px-12 my-1 focus:outline-none">
          <span
            class="p-1 my-1 mt-5 text-base font-medium cursor-pointer text-primary-200 hover:text-primary-500 lg:mt-3 hover:underline"
            >Sign In</span
          >
        </button>
      </div>
