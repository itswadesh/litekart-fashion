<template>
  <div class="container mx-auto">
    ...
    <div v-if="!signup && !otp">
      <span
        class="flex justify-center px-6 text-base font-thin text-center text-gray-400"
      ...
      <form novalidate autocomplete="off" @submit.stop.prevent="submit">
        ...
        <div class="w-full px-10">
          <div class="flex justify-end">
            <button
              class="flex justify-end my-2 text-xs font-light text-gray-400 underline focus:outline-none text-end"
            >
              Forgot Password?
            </button>
          </div>
          <button
            class="flex justify-center w-full px-4 py-2 text-lg font-semibold transition-colors border-2 rounded-md shadow hover:opacity-80 border-primary-500 focus:outline-none focus:ring-primary-500 focus:ring-2"
            :class="
      ...
      <div @click="signup = !signup" class="px-12 my-1">
        <span
          class="flex justify-center p-1 my-1 mt-5 text-sm font-medium cursor-pointer lg:mt-3 text-primary-200 hover:text-primary-500 hover:underline"
        >
          Not a Member yet?
        </span>
      </div>
