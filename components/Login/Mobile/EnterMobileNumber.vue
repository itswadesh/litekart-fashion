    ...
    <div v-if="!email" class="relative h-full">
      ...
      >
        ...
        <div class="relative mt-3">
          <Button
            class="flex justify-center w-4/5 px-4 py-2 mx-auto text-lg font-semibold transition-colors duration-300 rounded-md shadow hover:opacity-80 focus:outline-none focus:ring-primary-500 focus:ring-2"
