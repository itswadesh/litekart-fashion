<template>
  <div
    class="z-10 align-middle shadow-lg lg:mt-20 lg:overflow-y-auto lg:fixed lg:inset-0"
  >
    <div
    ...
    >
      ...
      <div
        class="inline-block w-full overflow-hidden transition-all transform text-start lg:my-8 lg:align-middle"
        role="dialog"
        aria-modal="true"
      ...
      >
        <div class="flex lg:justify-center">
          <div
            class="flex flex-row w-full h-full bg-white shadow-md lg:rounded-lg lg:w-3/5"
          >
            ...
            >
              <div class="relative h-full">
                ...
                <div>
                  <nuxt-link
                    to="/"
                    class="flex flex-col items-center justify-center py-16 font-semibold tracking-wider text-center lg:py-8"
                  >
                    <img
                ...
                <div class="bottom-0 w-full">
                  <p
                    class="flex flex-wrap justify-center w-11/12 mx-auto my-3 text-center lg:my-2 dddd"
                  >
                ...
                <button
                  ...
                  class="absolute top-0 right-0 mt-2 rounded-full me-2 hover:bg-gray-200"
                >
                  <svg
