<template>
  <div>
    <div
      class="container flex flex-row justify-center p-4 px-8 mx-auto text-xs font-medium tracking-wider text-center text-gray-500 www bg-accent-100"
    >
    ...
    <div class="container flex-wrap w-full mx-auto overflow-hidden bg-white">
      <div class="flex flex-row overflow-hidden">
        <div
          class="container grid flex-wrap w-full p-5 px-8 mx-auto md:grid-cols-2"
        >
          <label
            class="flex flex-col p-4 mx-2 mt-5 bg-white border rounded shadow-sm cursor-pointer hover:shadow-md"
            :class="{ 'border-secondary-500': picked == 'five' }"
          >
            <div class="flex flex-row">
              <Radio
                name="group"
                class="w-4 h-4 my-auto me-3 text-secondary-500 focus:ring-1 focus:ring-secondary-500"
                v-model="picked"
                value="five"
              />
