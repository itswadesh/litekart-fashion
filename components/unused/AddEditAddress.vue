    ...
    <div v-if="address">
      <form class="p-1 md:p-4" action @submit.prevent="submit">
        ...
        >
          ...
          <label class="flex flex-col-reverse col-span-2 md:col-span-1">
            <Textbox placeholder="" required v-model="address.state" />
            <span class="my-2">State</span>
          </label>

          <label class="flex flex-col-reverse col-span-2 md:col-span-1">
            <Textbox placeholder="" required v-model="address.country" />
            <span class="my-2">Country</span>
          </label>

          <label class="flex flex-col-reverse col-span-2 md:col-span-1">
            <Textbox placeholder="" required v-model="address.email" />
...
import { Textbox, Textarea } from '~/shared/components/ui'
