      ...
      >
        <span v-for="(input, index) in 4" :key="index">
          <input
            ...
            v-model="value[index]"
            :ref="'content' + index"
            class="w-12 p-3 text-center bg-white border border-none rounded shadow-md appearance-none none ring-1 ring-gray-100 focus:ring-1 focus:ring-primary-500 md:w-12"
            type="text"
            maxlength="1"
          />
        </span>
