<template>
  <div class="max-w-4xl pt-0 bg-white border border-collapse ms-4 me-3">
    <div class="flex flex-row justify-between">
      ...
      <button
        class="h-12 col-end-2 pl-2 pr-2 mx-auto mt-4 text-white duration-500 ease-in-out transform bg-blue-500 rounded shadow me-2 hover:-translate-y-1 hover:scale-95 md:mt-4 md:h-12 lg:h-12 md:font-semibold md:m-5 focus:outline-none"
      >
        Rate Product
      </button>
      <!-- </nuxt-link> -->
    ...
    <div class="grid grid-cols-1 pl-6 pr-8 mt-4 border-b">
      <span class="flex flex-row">
        <span
          class="w-10 h-6 pl-2 text-sm font-semibold text-white bg-green-600 rounded shadow me-3"
        >
          5★
        </span>
