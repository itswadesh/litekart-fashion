<template>
  <div class="container relative mx-auto">
    ...
    >
      <div>
        <div
          class="flex-row justify-between hidden p-4 md:flex md:justify-start md:p-5 md:px-8"
        >
      ...
      <div class="container max-w-full min-h-screen bg-gray-50">
        <div class="container p-5 mx-auto bg-white rounded-sm shadow-sm">
          <div class="flex flex-col-reverse w-full text-gray-600 md:flex-col">
            <h3
              class="flex flex-col justify-between float-right mt-2 text-sm ps-16 md:flex-row"
            >
              <span
                >Retun your Products within <b>15 days</b> after purchase</span
              >
              <h3
                class="flex flex-row justify-end w-auto h-8 p-1 my-auto rounded cursor-pointer text-secondary-500 md:px-6 md:hover:shadow md:hover:bg-blue-50"
              >
            ...
            <div class="flex flex-col-reverse md:flex-col">
              <div
                class="flex flex-row w-full p-5 px-4 py-1 pb-10 mt-10 text-sm md:px-16"
              >
                <div
                ...
                >
                  <div class="flex flex-col justify-between w-full md:flex-col">
                    <div class="hidden w-11/12 mx-auto text-center lg:flex">
                      <span
                        class="flex flex-shrink-0 mx-auto font-semibold text-gray-400 uppercase"
                    ...
                    >
                      ...
                      >
                        <button
                          class="w-8 h-8 border-2 rounded-full text-accent-600 border-accent-600 focus:outline-none"
                          :class="{
