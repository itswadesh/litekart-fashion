  ...
  >
    ...
    <div class="w-full my-4">
      <nuxt-link
        ...
        class="flex items-center justify-center w-full p-5 mb-5 text-center bg-white border border-gray-100 rounded shadow focus:outline-none hover:shadow-xl"
      >
        <svg
          ...
          <div v-else-if="data && data.addresses">
            ...
            >
              <nuxt-link
                ...
                class="absolute right-0 px-2 text-xs text-right border border-gray-300 rounded me-2"
                >Edit</nuxt-link
              >
...
export default {
  layout: 'account',
  middleware: ['isAuth'],
  components: { Heading, ListSkeleton },
  data() {
    return {
      // addresses: []
    }
